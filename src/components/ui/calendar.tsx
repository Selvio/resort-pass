...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      classNames={{
        root: cn("w-fit !shadow-none !border-none", defaultClassNames.root),
        months: cn(
        ...
        caption_label: cn(
          ...
          captionLayout === "label"
            ? "text-sm"
            : "rounded-full pl-2 pr-1 flex items-center gap-1 text-sm h-8 [&>svg]:text-secondary [&>svg]:size-3.5",
          defaultClassNames.caption_label
        ),
        table: "w-full border-collapse",
        weekdays: cn("flex", defaultClassNames.weekdays),
        weekday: cn(
          "text-primary rounded-full flex-1 font-normal text-sm select-none",
        ...
        week_number: cn(
          "text-sm select-none text-secondary",
...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        "text-sm data-[selected-single=true]:bg-primary data-[selected-single=true]:text-inverted-primary flex aspect-square size-auto w-full min-w-(--cell-size) flex-col gap-1 leading-none [&>span]:text-xs [&>span]:opacity-70 rounded-full",
        "data-[range-middle=true]:bg-accent data-[range-middle=true]:text-primary",
        "data-[range-start=true]:bg-primary data-[range-start=true]:text-inverted-primary",
        "data-[range-end=true]:bg-primary data-[range-end=true]:text-inverted-primary",
