...
function Command({
  ...
  return (
    <CommandPrimitive
      data-slot="command"
      className={cn(
        "bg-white flex h-full w-full flex-col overflow-hidden rounded-sm",
        className
      )}
      {...props}
    />
  ...
  const closeButton = (
    <DialogPrimitive.Close
      ...
      className={cn(
        ...
        "data-[state=open]:bg-accent data-[state=open]:text-muted-foreground absolute top-7 left-6 rounded-xs",
  ...
  return (
    <Dialog {...props}>
      ...
      <DialogContent
        ...
        className={cn(
          "overflow-hidden p-0 translate-y-0 top-2 bottom-0",
          className
        )}
      ...
      >
        <Command
          className={cn(
            "**:[[cmdk-group-heading]]:text-muted-foreground **:[[cmdk-group-heading]]:px-2 **:[[cmdk-group-heading]]:font-medium **:[[cmdk-group]]:px-2 [&_[cmdk-group]:not([hidden])_~[cmdk-group]]:pt-0",
            "**:data-[slot=command-input-wrapper]:h-12 [&_[cmdk-input-wrapper]_svg]:h-5 [&_[cmdk-input-wrapper]_svg]:w-5 **:[[cmdk-input]]:h-12",
